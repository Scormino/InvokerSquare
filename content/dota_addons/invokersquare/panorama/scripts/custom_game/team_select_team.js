...
{	
	...
	if ( GameUI.CustomUIConfig().team_colors )
	{
		...
		{
			var gradientText = 'gradient( linear, -100% -100%, 85% 100%, from( ' + teamColor + ' ), to( #00000000 ) );';
		...
		{
			var gradientText = 'gradient( linear, -800% -1600%, 90% 100%, from( ' + teamColor + ' ), to( #00000000 ) );';

...
LinkLuaModifier( "modifier_animation", "BarebonesLib/modifiers/modifier_animation.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_translate", "BarebonesLib/modifiers/modifier_animation_translate.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_translate_permanent", "BarebonesLib/modifiers/modifier_animation_translate_permanent.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_animation_freeze", "BarebonesLib/modifiers/modifier_animation_freeze.lua", LUA_MODIFIER_MOTION_NONE )
    ...
    Timers:CreateTimer(.066, function() 
      if translate2 ~= nil then
        SpellSystem:ApplyBuff({
            eCaster = unit,
            sBuff = "modifier_animation_translate",
            hStats = {duration=duration, translate=translate2}
          }
        )
      ...
      SpellSystem:ApplyBuff({
          eCaster = unit,
          sBuff = "modifier_animation",
          hStats = {duration=duration, translate=translate}
        }
      )      
...
function FreezeAnimation(unit, duration)
  if duration then
    SpellSystem:ApplyBuff({
        eCaster = unit,
        sBuff = "modifier_animation_freeze",
        hStats = {duration=duration}
      }
    )   
